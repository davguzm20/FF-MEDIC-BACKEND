...
-- Revocar acceso a audits al usuario de app
REVOKE ALL ON ff_medic_db.audits FROM ffmedic_app_user;

-- Otorgar permisos de solo lectura al usuario de auditoria
...
-- Otorgar permisos en secuencias al usuario de app
